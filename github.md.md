...
Diese Seite dient als Grundlage für Ihre ersten Schritte mit GitHub. Hier erfahren Sie, wie Sie ein GitHub-Konto erstellen, ein Repository anlegen und verwalten sowie grundlegende GitHub-Workflows wie Forking, Branching und Pull Requests verstehen.

## Inhalte

1. **Kontoerstellung**
   - Schritt-für-Schritt-Anleitung zur Erstellung eines GitHub-Kontos.
   - Sicherheitstipps: Einrichtung der Zwei-Faktor-Authentifizierung (2FA).

2. **Repository erstellen**
   - Anleitung zum Erstellen und Initialisieren eines eigenen Repositories.
   - Hinzufügen einer README.md-Datei und Durchführung der ersten Commits.

3. **Forking und Branching**
   - Forken eines Repositories und Erstellen einer eigenen Kopie.
   - Anlegen und Verwalten von Branches.
...
- [GitHub Konto anlegen](GitHub-Konto-anlegen.md)
